...
export default function BusinessOwnerCTA({ variant = "desktop" }) {
  ...
  if (isDesktop) {
    return (
      <section
        aria-label="Business owner call-to-action"
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          ...
          <div>
            <p style={{ color: "var(--mkt-text)", fontWeight: 700, fontSize: "0.95rem", marginBottom: 3 }}>Are you a business owner?</p>
            <p style={{ color: "var(--mkt-text-muted)", fontSize: "0.8rem" }}>Join V.Commerce and reach thousands of buyers who are actively looking to support community businesses.</p>
          </div>
        </div>
        <Link
          to="/vcommerce/apply"
        ...
        >
          Apply to Sell <IconArrowRight size={15} aria-hidden="true" />
        </Link>
      </section>
    );
  }
  ...
  return (
    ...
    >
      <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
        ...
        <p style={{ color: "var(--mkt-text)", fontWeight: 700, fontSize: "0.85rem" }}>Are you a business owner?</p>
      </div>
      <p style={{ color: "var(--mkt-text-muted)", fontSize: "0.78rem", lineHeight: 1.5 }}>
        Join V.Commerce and reach buyers who want to support community businesses.
      </p>
      <Link
        to="/vcommerce/apply"
      ...
      >
        Apply to Sell <IconArrowRight size={14} aria-hidden="true" />
      </Link>
    </section>
  );
}
