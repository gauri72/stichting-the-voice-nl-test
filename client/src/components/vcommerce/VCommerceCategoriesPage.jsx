...
const CATEGORIES = [
  ...
  { slug: "yoga",       key: "yoga",        emoji: "🧘" },
  { slug: "home",       key: "home",        emoji: "🏠" },
  { slug: "arts",       key: "arts",        emoji: "🎨" },
  { slug: "travel",     key: "travel",      emoji: "✈️" },
  { slug: "grocery",    key: "grocery",     emoji: "🛒" },
  { slug: "cosmetics",  key: "cosmetics",   emoji: "💄" },
  { slug: "electronics",key: "electronics", emoji: "🔌" },
  { slug: "beverages",  key: "beverages",   emoji: "🥤" },
  { slug: "household",  key: "household",   emoji: "🧹" },
];
  ...
  return (
    <div className="vcohp-page vco-mkt" style={{ minHeight: "100vh", background: "var(--mkt-bg)", padding: "28px 20px" }}>
      <div style={{ maxWidth: 900, margin: "0 auto" }}>
        <h1 style={{ color: "var(--mkt-text)", fontWeight: 800, fontSize: "1.6rem", marginBottom: 8 }}>{t("vcommerceShop:categoriesPage.title")}</h1>
        <p style={{ color: "var(--mkt-text-muted)", fontSize: "0.85rem", marginBottom: 28 }}>{t("vcommerceShop:categoriesPage.subtitle")}</p>

        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(160px, 1fr))", gap: 14 }}>
          {CATEGORIES.map(({ slug, key, emoji }) => {
            const label = t(`vcommerceShop:categoriesPage.categories.${key}`);
            return (
              <Link
