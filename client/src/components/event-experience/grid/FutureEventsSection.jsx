...
export default function FutureEventsSection() {
  ...
  return (
    <section aria-label="Future Events" className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
      <h2 className="mb-2 text-2xl font-extrabold text-evx-heading sm:text-3xl">Future Events</h2>
      <p className="mb-6 text-sm text-evx-text-muted">
        {totalCount} upcoming experience{totalCount === 1 ? "" : "s"}
      </p>
