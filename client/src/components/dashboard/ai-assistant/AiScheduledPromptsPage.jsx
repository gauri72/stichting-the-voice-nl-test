  ...
  return (
    <div className="rounded-2xl bg-gradient-to-b from-slate-900 via-slate-950 to-black p-5 text-slate-100 ring-1 ring-white/10">
      <div className="mb-4 flex items-center justify-between">
        <div>
          <h2 className="text-lg font-semibold">Scheduled Prompts</h2>
          <p className="text-sm text-slate-400">Automatic check-ins, delivered however you like.</p>
        </div>
        <button
          type="button"
      ...
      {sorted.length === 0 ? (
        <div className="rounded-xl border border-dashed border-white/10 p-8 text-center text-sm text-slate-500">
          No scheduled prompts yet. Create one to get automatic updates.
        </div>
      ) : (
