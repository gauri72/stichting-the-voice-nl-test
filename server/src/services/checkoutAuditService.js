...
export const CHECKOUT_AUDIT_ACTIONS = {
  ...
  CHECKOUT_SESSION_SAVED_BEFORE_LOGIN: "checkout_session_saved_before_login",
  CHECKOUT_SESSION_RESTORED_AFTER_LOGIN: "checkout_session_restored_after_login",
  MEMBER_DISCOUNT_APPLIED_AFTER_LOGIN: "member_discount_applied_after_login",
  MEMBERSHIP_CODE_VALIDATED: "membership_code_validated",
  MEMBERSHIP_CODE_REJECTED: "membership_code_rejected",
