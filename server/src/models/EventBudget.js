...
const eventBudgetSchema = new mongoose.Schema(
  {
    ...
    plannedIncomeLines: { type: [incomeLineSchema], default: [] },
    actualIncomeLines: { type: [incomeLineSchema], default: [] },
    plannedExpenseLines: { type: [expenseLineSchema], default: [] },
    actualExpenseLines: { type: [expenseLineSchema], default: [] },
