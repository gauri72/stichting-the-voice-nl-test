...
import adminContactSubmissionsRoutes from "./adminContactSubmissionsRoutes.js";
import adminLoginActivityRoutes from "./adminLoginActivityRoutes.js";
import adminEventNotificationRoutes from "./adminEventNotificationRoutes.js";
...
router.use("/contact-submissions", requireAdmin, adminContactSubmissionsRoutes);
router.use("/login-activity", requireAdmin, adminLoginActivityRoutes);
router.use("/event-notifications", requireAdmin, adminEventNotificationRoutes);
